...
def create_new_sheet(client, folder_id, base_sheet_name, sheet_number):
    ...
    # new_sheet_name = f'{base_sheet_name}_{sheet_number}'
    # Create a new Google Sheets file in the desired folder
    file_metadata = {
        'name': new_sheet_name,
        'parents': [folder_id],
                        ...
                        if email and phone:
                            ...
                            try:
                                ...
                                if current_row_count1 >= max_records_per_sheet1:
                                    sheet_number1 += 1
                                    current_sheet1 = create_new_sheet(client, folder_id1, base_sheet_name1,
                                                                      sheet_number1)
                                    current_row_count1 = 0

                                if current_row_count2 >= max_records_per_sheet2:
                                    sheet_number2 += 1
                                    current_sheet2 = create_new_sheet(client, folder_id2, base_sheet_name2,
                                                                      sheet_number2)
                                    current_row_count2 = 0
